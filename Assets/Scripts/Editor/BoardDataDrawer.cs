...
public class BoardDataDrawer : Editor
{
    ...
    {
        var tableStyle = new GUIStyle("box");//01
        ...
        rowStyle.alignment = TextAnchor.MiddleCenter;//01 Display different look of headers
        ...
        EditorGUILayout.BeginHorizontal(tableStyle);//new
    ...
    private void InitializeReordableList(ref ReorderableList list, string propertyName, string listLabel)//p5
    {
